...
| 마일스톤 | 상태 | 산출물 |
|---|---|---|
| M0. 데이터 해상도 검증 게이트 | 조건부 통과 | `reports/m0_m1_data_pipeline.md` |
